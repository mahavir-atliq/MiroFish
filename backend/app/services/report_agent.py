...
Implements a ReACT-pattern simulation report generator using LangChain + Zep

Features:
1. Generate reports based on simulation requirements and Zep graph information
2. First plan the table of contents structure, then generate section by section
3. Each section uses a multi-round ReACT thinking and reflection pattern
...
class ReportLogger:
    ...
    def log_section_full_complete(
        ...
        The frontend should monitor this log to determine when a section is truly complete and to obtain the full content
        """
        self.log(
...
Calls the OASIS simulation environment's interview API to conduct real interviews with simulated agents!
This is not LLM simulation — it calls the real interview interface to get raw answers from simulated agents.
...
[Use Cases]
- Need to understand different role perspectives on an event (how do students see it? media? officials?)
...
PLAN_SYSTEM_PROMPT = """\
You are an expert writer of "Future Prediction Reports," possessing a "God's perspective" on the simulated world — you can observe the behavior, statements, and interactions of every agent in the simulation.

[Core Concept]
We have built a simulated world and injected a specific "simulation requirement" as a variable. The evolution result of the simulated world is a prediction of what may happen in the future. What you are observing is not "experimental data," but "a rehearsal of the future."
...
- ✅ The words and actions of agents in the simulated world are predictions of future human group behavior
...
[Reminder] Number of report sections: at least 2, at most 5, content should be concise and focused on core prediction findings."""
...
the behavior and interactions of agents in the simulation are predictions of future human group behavior.
...
2. [Must quote agents' original words and actions]
   - Agents' statements and behaviors are predictions of future human group behavior
...
3. [Language consistency - quoted content must be translated into the report language]
   ...
   - Keep the original meaning intact and ensure natural, smooth expression
...
- ❌ Forbidden to add the section main title at the beginning of content
- ✅ Section titles are added automatically by the system; you only need to write the plain body text
- ✅ Use **bold**, paragraph breaks, quotes, and lists to organize content, but do not use headings

[Correct example]
```
This section analyzes the spread of public opinion around the event. Through in-depth analysis of simulation data, we found...
...
When you have gathered enough information through tools, start with "Final Answer:" to output the section content.

⚠️ Strictly forbidden:
- Forbidden to include both a tool call and a Final Answer in one reply
...
4. [Quote format specification - must be on its own line]
   ...
   > "The school's response pattern appeared rigid and slow in the ever-changing social media environment."
...
REACT_INSUFFICIENT_TOOLS_MSG_ALT = (
    "You have only called {tool_calls_count} tools; at least {min_tool_calls} are required. "
...
class ReportAgent:
    ...
    1. Planning phase: Analyze simulation requirements, plan the report table of contents structure
    2. Generation phase: Generate content section by section; each section may call tools multiple times to gather information
    ...
    def _execute_tool(self, tool_name: str, parameters: Dict[str, Any], report_context: str = "") -> str:
        ...
        try:
            if tool_name == "insight_forge":
                ...
                # In-depth interview - calls the real OASIS interview API to get simulated agent answers (dual platform)
    ...
    def _parse_tool_calls(self, response: str) -> List[Dict[str, Any]]:
        ...
        # Only attempted when format 1 did not match, to avoid false matches in body text JSON
    ...
    def _generate_section_react(
        ...
        if previous_sections:
            ...
            for sec in previous_sections:
                # Up to 4000 characters per section
        ...
        for iteration in range(max_iterations):
            ...
            if has_tool_calls:
                # Tool quota exhausted → clearly notify and require Final Answer output
            ...
            # Directly adopt this content as the final answer without further cycling
    ...
    def generate_report(
        ...
        try:
            ...
            # Initialize structured log recorder (agent_log.jsonl)
            ...
            # Phase 2: Generate section by section (save as each is generated)
            ...
            try:
                ...
                pass  # Ignore errors saving the failed state
...
class ReportManager:
    ...
    def save_section(
        ...
        # Build section Markdown content - clean up any duplicate titles that may exist
    ...
    def _clean_section_content(cls, content: str, section_title: str) -> str:
        ...
        2. Convert all ### and deeper level headings to bold text
    ...
    def _post_process_report(cls, content: str, outline: ReportOutline) -> str:
        ...
        while i < len(lines):
            ...
            if heading_match:
                ...
                # Check if heading is a duplicate (same heading content within previous 5 lines)
                is_duplicate = False
                ...
                if level == 1:
                    ...
                    # ### and deeper level headings converted to bold text
                    processed_lines.append(f"**{title}**")
                    processed_lines.append("")
                    prev_was_heading = False
        ...
        for item in os.listdir(cls.REPORTS_DIR):
            ...
            if os.path.isdir(item_path):
                ...
                if report and report.simulation_id == simulation_id:
                    return report
            # Backward compatibility with old format: JSON file
    ...
    def delete_report(cls, report_id: str) -> bool:
        ...
        # Backward compatibility with old format: delete individual files
        deleted = False
