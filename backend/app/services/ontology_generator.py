...
- We need to simulate the reactions of all parties in opinion events and the paths of information dissemination

Therefore, **entities must be real, existing subjects that can speak and interact on social media**:
...
- The text will contain various figures, such as "primary and secondary school teachers", "passersby", "some netizens"
...
- Ensure that relationship source_targets cover the entity types you defined
...
**Individual (fallback)**:
- Person: Any natural person (use when not fitting the above specific types)
...
4. All entity types must be real subjects that can speak in reality; they cannot be abstract concepts
