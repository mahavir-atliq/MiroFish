...
this module encapsulates automatic pagination logic (including per-page retries)
and transparently returns the full list to the caller.
"""
...
def fetch_all_nodes(
    ...
    """Paginated fetch of graph nodes, returning at most max_items items (default 2000). Each page request includes retry logic."""
    all_nodes: list[Any] = []
...
def fetch_all_edges(
    ...
    """Paginated fetch of all graph edges, returning the full list. Each page request includes retry logic."""
    all_edges: list[Any] = []
    cursor: str | None = None
    page_num = 0
